...
"""Train huggingface models on our dataset"""
...
class DataTrainingArguments:
    ...
    task_name: Optional[str] = field(
        ...
        metadata={
            ...
            ", ".join(["summary_only", "full_script_only"])
        },
    )
...
def main():
    ...
    datasets = load_dataset("movie_character_identification")
    ...
    if (model.config.label2id !=
            ...
            and data_args.task_name is not None and False):
